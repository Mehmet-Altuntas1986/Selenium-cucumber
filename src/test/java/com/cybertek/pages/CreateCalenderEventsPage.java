...
public class CreateCalenderEventsPage extends BasePage {
    ...
    public WebElement repeat;    //repeat adinda icine thick koyulan bir box var-->create calender event e tiklayinca
                                 //repeat everyday is radio button--in create calender event
